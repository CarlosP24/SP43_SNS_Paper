function fig_valve_RL(layout_LDOS, kws_LDOS, layout_currents, kws_currents; vcolors = [:lightblue, :lightblue], xticks = 0:0.05:0.25)
    ...
    Label(fig_LDOS[1, 1, Top()], L"$L \rightarrow \infty$", padding = (420, 0, -40, 0), color = :white)
    Label(fig_LDOS[2, 1, Top()], L"$L = 2.5\mu$m", padding = (420, 0, -40, 0), color = :white)
...
fig = fig_valve_RL(layout_LDOS, kws_LDOS, layout_currents, kws_currents)
save("figures/fig_valve_RL.pdf", fig)
fig