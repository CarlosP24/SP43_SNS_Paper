function cphase(pos, name::String, TN, Φ; basepath = "data", colors = [:green, :red], lw = 0.5, showmajo = false, Zs = nothing, total = true, totalstyle = :solid, totalwidth = 1)
    ...
    total && lines!(ax, φrng, J; color = :black, linestyle = totalstyle, linewidth = totalwidth, label = L"$$ Total")
