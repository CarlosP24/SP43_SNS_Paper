...
function plot_FVQ(ax, xrng, xticksL, xticksR, Ic; color, linestyle, linewidth, label, kws... )
    ...
    lines!(ax, xrng, FVQ; color, linestyle, linewidth = 2, label)
...
function plot_fluxoid(ax, xticks, ylower, yupper; colormap = :rainbow, kws...)
    pushfirst!(xticks, 0)
